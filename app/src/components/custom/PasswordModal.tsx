          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white">Edit Mode</h3>
                  <p className="text-sm text-white/50">Enter password to enable editing</p>
                </div>
              </div>
              <button
                onClick={handleClose}
            ...
            <form onSubmit={handleSubmit}>
              <div className="relative mb-4">
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl bg-white/5 border border-white/20 text-white placeholder:text-white/30 pr-12 focus:border-white/40 focus:outline-none ${
